  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 pt-24 pb-[calc(5.5rem_+_env(safe-area-inset-bottom))] sm:px-6 md:pb-10 lg:px-8">
      <section className="mb-8 animate-pulse">
        ...
        <div className="mt-3 h-9 w-[min(420px,80%)] rounded-lg bg-white/[0.06]" />
        <div className="mt-3 h-4 w-[min(340px,70%)] rounded bg-white/[0.05]" />
      </section>

      <div className="grid gap-4 lg:grid-cols-12 lg:items-stretch">
        <div className="h-[300px] animate-pulse rounded-[14px] border border-white/[0.06] bg-[#1c1c1e] lg:col-span-7" />
        <div className="h-[300px] animate-pulse rounded-[14px] border border-white/[0.06] bg-[#1c1c1e] lg:col-span-5" />
      </div>
    </div>
  );
}
