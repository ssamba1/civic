...
const MapView = forwardRef<MapRef, MapProps>(function MapView(
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: map is created once on mount; viewport/style/theme changes are handled by the dedicated effects below, not by re-creating the GL context.
  useEffect(() => {
...
function MapMarker({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: marker is created once; live longitude/latitude/draggable are reconciled imperatively below.
...
function MarkerTooltip({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: popup is created once; option changes are reconciled imperatively below.
