              ...
              <section className="space-y-4">
                  ...
                  {iconsExpanded && (
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-white/[0.08] bg-white/[0.03] py-1.5 pl-8 pr-3 text-[13px] text-white placeholder:text-zinc-600 outline-none focus:border-[#0a84ff]/60 focus:ring-1 focus:ring-[#0a84ff]/40"
                      />
                    </div>
                  )}
                  ...
                  >
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selectedIcon === key
                            ...
                            : "border-white/[0.08] bg-white/[0.03] text-zinc-500 hover:border-white/[0.16] hover:text-zinc-200",
                        )}
                        style={
                          selectedIcon === key
                            ? { background: color }
                    ...
                    {!iconsExpanded && (
                      <button
                        ...
                        className="flex h-9 items-center gap-1.5 rounded-lg border border-dashed border-white/[0.16] px-3 text-[12px] font-medium text-zinc-400 transition-colors hover:border-white/[0.28] hover:text-zinc-200"
                      >
                    ...
                    {iconsExpanded && visibleIcons.length === 0 && (
                      <p className="px-1 py-2 text-[12px] text-zinc-600">
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    className="resize-none rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-sm text-white placeholder:text-zinc-600 outline-none focus:border-[#0a84ff]/60 focus:ring-1 focus:ring-[#0a84ff]/40"
                  />
                </label>
              </section>
                      ...
                      <li key={c.id}>
                        <div
                          className={cn(
                            ...
                            checked ? "bg-[#0a84ff]/10" : "hover:bg-white/[0.03]",
                          )}
                        >
                          <button
                            type="button"
                          ...
                          <button
                            ...
                            className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md text-zinc-500 transition-colors hover:bg-white/[0.06] hover:text-zinc-200"
                          >
                ...
                {addingCategory ? (
                  <div className="space-y-2.5 rounded-lg border border-white/[0.08] bg-white/[0.02] p-3">
                    <input
                      ...
                      className="w-full rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-sm text-white placeholder:text-zinc-600 outline-none focus:border-[#0a84ff]/60 focus:ring-1 focus:ring-[#0a84ff]/40"
                    />
                    <div className="flex flex-wrap items-center gap-2">
                      {COLOR_PRESETS.map((c) => (
                        <button
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="rounded-md px-3 py-1.5 text-[12px] font-medium text-zinc-400 transition-colors hover:text-zinc-200"
                      >
                        Cancel
                      </button>
                      <button
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-white/[0.12] px-3 py-2.5 text-[13px] font-medium text-zinc-400 transition-colors hover:border-white/[0.24] hover:text-zinc-200"
                  >
